...
from ldm.modules.losses.edge_loss import GradEdge3D ,GMELoss3D
...
class VQLPIPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
                 ...
                 disc_ndf=64, disc_loss="hinge", n_classes=None, perceptual_loss="lpips", edge_loss_weight= 0.2,
                 pixel_loss="l1"):
        super().__init__()
        ...
        if self.edge_loss_weight>0:
            self.edge_loss = GMELoss3D(n1=1,n2=1,n3=1 ,reduction='mean')
    ...
    def forward(self, codebook_loss, inputs, reconstructions, optimizer_idx,
        ...
        if self.edge_loss_weight > 0:
            edge_gradient_loss  =  self.edge_loss(inputs , reconstructions)
            print("edge_gradient_loss:" , edge_gradient_loss)
        ...
        if optimizer_idx == 0:
            ...
            nll_loss = rec_loss
            if self.edge_loss_weight >0:
                nll_loss = nll_loss + self.edge_loss_weight * edge_gradient_loss
            ...
            log = {"{}/total_loss".format(split): loss.clone().detach().mean(),
                   ...
                   "{}/gradient_loss".format(split): edge_gradient_loss.detach().mean(),
